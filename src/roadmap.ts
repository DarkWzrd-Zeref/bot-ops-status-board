...
export const ROADMAP: RoadmapItem[] = [
  ...
  },
  {
    ...
    status: "BUILDING",
    outcome: "Public metadata stays static; private packets require explicit per-packet promotion through an in-memory authenticated session.",
    blocker: "Production OAuth and encrypted remote storage are not deployed; localStorage itself must never receive secrets.",
